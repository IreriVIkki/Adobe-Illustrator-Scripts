...
try {
    ...
    if (app.documents.length > 0) {
        ...
        rootFolder = Folder.selectDialog(
            "Select root folder to save your files into.",
            "~",
        );
        ...
        if (rootFolder != null) {
            ...
            try {
                ...
                sourceDoc.exportFile(targetFile, ExportType.PHOTOSHOP, options);
            } catch (e) {
                throw e;
            }
            ...
            try {
                ...
                sourceDoc.exportFile(targetFile, ExportType.AUTOCAD, options);
            } catch (error) {
                throw error;
            }
